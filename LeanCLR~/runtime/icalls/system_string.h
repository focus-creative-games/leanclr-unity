...
class SystemString
{
  public:
    ...
    static RtResult<vm::RtString*> newobj_utf8chars(const int8_t* chars);
    static RtResult<vm::RtString*> newobj_utf8chars_range(const int8_t* chars, int32_t startIndex, int32_t length);
